...
import { Save, Wand2, Image as ImageIcon } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            />
            {data.imageUrl && (
              <div className="mt-2 aspect-video rounded-lg overflow-hidden bg-gray-100 border border-gray-200 max-w-md">
