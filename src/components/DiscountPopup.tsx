...
export default function DiscountPopup({ onClose }: DiscountPopupProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 font-body">
      ...
      {/* Pop-up Container */}
      <div className="relative w-full max-w-md bg-white shadow-2xl flex flex-col overflow-hidden border border-gray-200 rounded-none">
        {/* Close Button */}
        <button 
          onClick={onClose}
          className="absolute top-4 right-4 text-gray-500 hover:text-slate-900 transition-colors p-1 z-10"
        >
          <X size={24} />
        </button>
